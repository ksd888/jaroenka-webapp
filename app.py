...
required_columns = {"ชื่อสินค้า", "ราคาขาย", "ต้นทุน", "ออก", "คงเหลือในตู้"}
if not required_columns.issubset(set(df.columns)):
    st.error("❌ Google Sheet ไม่ได้มีคอลัมน์ที่จำเป็นครบถ้วน: " + ", ".join(required_columns - set(df.columns)))
    st.stop()
...
if st.button("➕ เพิ่มลงตะกร้า"):
    ...
    st.session_state.search_items = []  # ✅ reset รายการค้นหา
