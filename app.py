...
if st.session_state.sale_complete:
    ...
    st.success("✅ บันทึกและรีเซ็ตสำเร็จแล้ว")
...
selected = st.multiselect("ค้นหาสินค้า", product_names, default=st.session_state.selected_products)
